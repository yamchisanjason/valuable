...
class IBapi(EWrapper, EClient):
    ...
    def execute_trade(self, action, price, take_profit, stop_loss):
        ...
        self.position_size = int(self.account_balance / self.stop_loss_distance)
        ...
        self.placeOrder(self.nextValidId(), contract, order)    #replace with the next valid order ID
        ...
        if action == 'BUY':
            ...
            self.account_balance += price * self.position_size
